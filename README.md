...
# Data Management Plan "Lubricants-MD"
...
> Bridging Time and Length Scales: From Atomistic Simulations to Constitutive Models
...
```bash
git clone git@github.com:reproducible-reporting/dmp-lubricants-rb.git
cd dmp-lubricants-rb
./setup-venv-pip.sh
direnv allow
pre-commit install
cd dmp
